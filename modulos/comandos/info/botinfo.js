  ...
  run: async (bot, message, args) => {
   message.delete();
      message.channel.send(new Discord.MessageEmbed()
            ...
            .addField('❯ Conteo de Servidores:', `${bot.guilds.cache.size} guilds`, true)
            .addField(`❯ Conteo de Usuarios:`, `${bot.guilds.cache.reduce((users , value) => users + value.memberCount, 0)} users`, true)
            .addField('❯ Comandos:', `${bot.commands.size} cmds`,true)
